...
from Experiments.data_loader import swat_data
...
# test data
_, x_curr, x_next, u_curr, labels = bdm.prepare_data(test_df, signal_variables=signal_variables,
...
bdm = bdm.load_model(path=r'Experiments/results/SWAT/BDM')
